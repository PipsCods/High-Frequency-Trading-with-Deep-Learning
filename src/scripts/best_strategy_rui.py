...
for j in ['200_CROSS_None_0.33_prediction',
          '200_CROSS_None_0.66_prediction',
          '200_CROSS_time_0.33_prediction',
          '200_CROSS_time_0.66_prediction',
          '200_time_CROSS_0.33_prediction',
          '200_time_CROSS_0.66_prediction',
          '200_time_None_0.33_prediction',
          '200_time_None_0.66_prediction']:
    data_transformer=pd.read_csv(f'/Users/emanueledurante/Desktop/LGMB/lausanne/epfl/MLfinance/High-Frequency-Trading-with-Deep-Learning/data/predictions_transformers/{j}.csv')
    data_transformer = data_transformer.pivot(index="index", columns="stock", values="pred_return").fillna(0)
